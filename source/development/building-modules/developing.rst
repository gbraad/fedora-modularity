...
including the components, API, and all the information necessary to build
your module like specifying build dependencies and a build order for the
packages. Let’s have a look at an example Vim module:
